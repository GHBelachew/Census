...
pop21_PGH_pop<- get_acs(geography = "msa",
                        variables =  all_var,
                        year = 2021,
                        region = "Metropolitan statistical area/metropolitan stattistical area:*",
...
pop21_SPC_Tr <- get_acs(geography = "tract",
                        variables =  all_var,
                        year = 2021,
                        state = "PA",
                        county = c("Allegheny","Armstrong","Beaver",
...
#7. SPC Region block group
# This is not needed for now
pop21_SPC_bg <- get_acs(geography = "block group",
                        variables =  all_var,
                        year = 2021,
                        state = "PA",
                        county = c("Allegheny","Armstrong","Beaver",
...
data_all <- rbind(pop21_us,pop21_PA, pop21_SPC_Co, pop21_SPC_Muni)




# because data all has the Estiamte and margial errrors, we need the estimates only, hence

# get the first tow column 
...
data_all_F2_Long<- reshape2::melt(data_all_F2,id.vars = c("GEOID","NAME"))

# Save this to CSV

write.csv(data_all_F2,"C:/Users/ayele/CensusDataTest/Data/ACS_2017_2021_w.csv", row.names = FALSE)
write.csv(data_all_F2_Long,"C:/Users/ayele/CensusDataTest/Data/ACS_2017_2021_L.csv", row.names = FALSE)
write.csv(v21,"C:/Users/ayele/CensusDataTest/Data/VAr_ACS_2017_2021.csv", row.names = FALSE) # Variables 
write.csv(v19,"C:/Users/ayele/CensusDataTest/Data/VAr_ACS_2015_2019.csv", row.names = FALSE) # Variables
